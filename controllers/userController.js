...
class UserController {
    async registration(req, res, next) {
        try {
            ...
            const {email, username, firstName, lastName, password} = req.body; //вытаскиваем из тела запроса почту и пароль
            // const latinName = transliter(username);
            const userData = await userService.registration(email, username, firstName, lastName, password);
